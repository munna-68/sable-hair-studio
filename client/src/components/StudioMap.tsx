 ...
 * Chromatic Cut palette: porcelain base, hairline streets, emerald mark.
 */
    ...
    >
      <defs>
        <linearGradient id="map-sheen" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#E3EBE0" />
          <stop offset="100%" stopColor="#CFD8C8" />
        </linearGradient>
        <filter id="marker-shadow" x="-60%" y="-60%" width="220%" height="220%">
          <feDropShadow dx="0" dy="3" stdDeviation="4" floodColor="#0A1F14" floodOpacity="0.28" />
        </filter>
      </defs>
      ...
      {/* City blocks */}
      <g fill="#CFD8C8" stroke="#C4CDBD" strokeWidth="1">
      ...
      <g>
        <rect x="464" y="220" width="136" height="90" fill="#CDE8D3" stroke="#8FD0A0" strokeWidth="1" />
        <g fill="#3FA968">
      ...
      <g strokeLinecap="square">
        {STREETS.horizontal.map((street) => (
          <g key={street.label}>
            <line x1="0" y1={street.y} x2="760" y2={street.y} stroke="#C4CDBD" strokeWidth={street.major ? 22 : 16} />
            <line x1="0" y1={street.y} x2="760" y2={street.y} stroke="#FCFDFB" strokeWidth={street.major ? 18 : 12} />
          </g>
        ))}
        {STREETS.vertical.map((street) => (
          <g key={street.label}>
            <line x1={street.x} y1="0" x2={street.x} y2="520" stroke="#C4CDBD" strokeWidth={street.major ? 22 : 16} />
            <line x1={street.x} y1="0" x2={street.x} y2="520" stroke="#FCFDFB" strokeWidth={street.major ? 18 : 12} />
          </g>
        ))}
      </g>

      {/* Centre line on the two arterials */}
      <g stroke="#C4CDBD" strokeWidth="2" strokeDasharray="10 12">
      ...
      <g transform={`translate(${STUDIO.x} ${STUDIO.y})`}>
        <circle className="studio-map-pulse" r="17" fill="#147A45" opacity="0.18" />
        <circle r="15" fill="#147A45" filter="url(#marker-shadow)" />
        <circle r="6" fill="#FCFDFB" />
      </g>

      {/* Callout */}
      <g transform="translate(60 132)">
        <rect x="0" y="0" width="228" height="66" fill="#0A1F14" stroke="#147A45" strokeWidth="1" />
      ...
      <line x1="288" y1="165" x2="286" y2="112" stroke="#0A1F14" strokeWidth="1.5" strokeDasharray="4 4" />

      {/* Compass + scale plate */}
      <g transform="translate(688 44)">
        <circle r="22" fill="#FCFDFB" stroke="#C4CDBD" strokeWidth="1" />
        <path d="M0 -13 L5 6 L0 2 L-5 6 Z" fill="#147A45" />
        <text x="0" y="-26" textAnchor="middle" className="studio-map-compass">
          N
        </text>
      </g>
      <g transform="translate(628 486)">
        <line x1="0" y1="0" x2="104" y2="0" stroke="#0A1F14" strokeWidth="2" />
        <line x1="0" y1="-5" x2="0" y2="5" stroke="#0A1F14" strokeWidth="2" />
        <line x1="104" y1="-5" x2="104" y2="5" stroke="#0A1F14" strokeWidth="2" />
